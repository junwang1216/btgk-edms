...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script async type="text/javascript" src="Content/js/require.js?v=${static_resource_version}"
            data-main="Content/js/app/web_document/search.js?v=${static_resource_version}"></script>
</layout:override>
    ...
    <div class="page-container">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8 main-listing">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <span>计算机科技类</span>
                            <a href="/web/document/list?class=1&keywords=${keywords}" class="pull-right">
                                <span class="glyphicon glyphicon-list"></span> 更多
                            </a>
                        </div>
                ...
                <%@include file="../Web/SideBar.jsp" %>
            </div>
        </div>
    </div>
</layout:override>

<c:import url="../Web/GeneralLayout.jsp">
