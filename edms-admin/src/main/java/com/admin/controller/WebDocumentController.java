...
public class WebDocumentController extends WebBaseController {
    ...
    public ModelAndView renderDocumentSearch() {
        return new ModelAndView("WebDocument/Search")
