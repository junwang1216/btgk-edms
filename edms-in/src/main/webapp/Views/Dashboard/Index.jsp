...
<layout:override name="<%=Blocks.BLOCK_HEADER_SCRIPTS%>">
    <script async type="text/javascript" src="Content/js/require.js?v=${static_resource_version}"
            data-main="Content/js/app/admin_dashboard/index.js?v=${static_resource_version}"></script>
</layout:override>
                            ...
                            <table class="table table-hover table-outline mb-0 hidden-sm-down">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="Content/images/avatars/1.jpg?v=${static_resource_version}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/USA.png?v=${static_resource_version}" alt="USA" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="Content/images/avatars/2.jpg?v=${static_resource_version}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/Brazil.png?v=${static_resource_version}" alt="Brazil" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="Content/images/avatars/3.jpg?v=${static_resource_version}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/India.png?v=${static_resource_version}" alt="India" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="Content/images/avatars/4.jpg?v=${static_resource_version}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/France.png?v=${static_resource_version}" alt="France" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="avatar">
                                            <img src="Content/images/avatars/5.jpg?v=${static_resource_version}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                            <span class="avatar-status badge-success"></span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/Spain.png?v=${static_resource_version}" alt="Spain" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="Content/images/flags/Poland.png?v=${static_resource_version}" alt="Poland" style="height:24px;">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                            <div class="float-left">
